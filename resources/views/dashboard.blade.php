    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-4">
                    <div class="flex items-center">
                        ...
                        <div class="flex-shrink-0 mr-4">
                            ...
                            @else
                                <div class="h-16 w-16 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center">
                                    <span class="text-gray-600 dark:text-gray-300 text-2xl">{{ substr(Auth::user()->name, 0, 1) }}</span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('users.show', Auth::user()) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
            ...
            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" role="tablist">
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:border-gray-300 hover:text-gray-600 dark:hover:text-gray-300 tab-button active" 
                                id="lists-tab" 
                    ...
                    <li class="mr-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:border-gray-300 hover:text-gray-600 dark:hover:text-gray-300 tab-button" 
                                id="favorites-tab" 
                        ...
                        @else
                            <div class="text-center p-10 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg">
                                ...
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                    <a href="{{ route('anime-lists.browse') }}" class="text-blue-500 hover:underline">Browse community lists</a> to find lists you like!
                                </p>
                            </div>
                        @endif
                    </div>
            ...
            <div id="following-content" class="tab-content hidden">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-6">Users You're Following</h3>
                                        ...
                                        <div class="p-5 flex items-center">
                                            ...
                                            <div class="mr-4 flex-shrink-0">
                                                @if($followedUser->profile_picture)
                                                    <img src="{{ Storage::url($followedUser->profile_picture) }}" class="h-12 w-12 rounded-full object-cover" alt="{{ $followedUser->name }}">
                                                @else
                                                    <div class="h-12 w-12 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center">
                                                        <span class="text-gray-600 dark:text-gray-300 text-xl">{{ substr($followedUser->name, 0, 1) }}</span>
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            <!-- User info -->
                                            <div class="flex-grow">
                                                <h4 class="font-medium text-gray-900 dark:text-white">{{ $followedUser->name }}</h4>
                                            ...
                                            <!-- View profile button -->
                                            <a href="{{ route('users.show', $followedUser) }}" class="flex-shrink-0 text-blue-500 hover:text-blue-700">
                                                View Profile
                                            </a>
                                        </div>
                                    </div>
                        ...
                        @else
                            <div class="text-center p-10 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg">
                                ...
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                    <a href="{{ route('anime-lists.browse') }}" class="text-blue-500 hover:underline">Browse community lists</a> to find users to follow!
                                </p>
                            </div>
                        @endif
                    </div>
